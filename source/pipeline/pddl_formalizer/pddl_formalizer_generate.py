...
def run_deepseek(client, domain, data, model, constraint_type, problem, constraint):
    ...
    df_path = f'../../../output/llm-as-pddl-formalizer/{domain}/{data}/generate/{model}/{constraint_type}/{problem}/{problem}_{constraint}_{model}_df.pddl'
    pf_path = f'../../../output/llm-as-pddl-formalizer/{domain}/{data}/generate/{model}/{constraint_type}/{problem}/{problem}_{constraint}_{model}_pf.pddl'
