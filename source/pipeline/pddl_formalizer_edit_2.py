...
def run_deepseek(client, domain, data, model, constraint_type, problem, constraint):
    original_domain_file = open(f'../../output/llm-as-formalizer/{domain}/{data}/edit/{model}/original/{problem}/{problem}_{model}_df.pddl').read()
    original_problem_file = open(f'../../output/llm-as-formalizer/{domain}/{data}/edit/{model}/original/{problem}/{problem}_{model}_pf.pddl').read()
    ...
    df_path = f'../../output/llm-as-formalizer/{domain}/{data}/edit/{model}/{constraint_type}/{problem}/{problem}_{constraint}_{model}_df.pddl'
    pf_path = f'../../output/llm-as-formalizer/{domain}/{data}/edit/{model}/{constraint_type}/{problem}/{problem}_{constraint}_{model}_pf.pddl'
